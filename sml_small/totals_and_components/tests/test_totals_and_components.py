    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "202312",
                100,
                [Component_list(1, None), Component_list(2, None), Component_list(3, None), Component_list(4, None)],
                101.0,
                102.0,
                "202312",
                300.0,
                20,
                0.1,
                (100, [Component_list(1, None), Component_list(2, None), Component_list(3, None), Component_list(4, None)], 102.0, 300.0, 20, 0.1),
            ...
            (
                ...
                105.0,
                None,
                (100.0, [Component_list(1, None), Component_list(2, None), Component_list(3, None), Component_list(4, None)], 103.0, 104.0, 105.0, None),
            ...
            (
                ...
                104.0, None,
                20,
                (100.0, [Component_list(1, None), Component_list(2, None), Component_list(3, None), Component_list(4, None)], 103.0, 104.0, None, 20),
            ...
            (
                ...
                "202312",
                100.0,
                [Component_list(None, None), Component_list(2, None), Component_list(3, None), Component_list(4, None)],
                101.0,
                102.0,
                "202312",
                103.0,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("C", "202312", 1964, [Component_list(632, None), Component_list(732, None), Component_list(99, None),
             ...
             "202312", None, 1, None, "M", "Test 3: TCC Marker M (Determine error detection method stage 5 - Manual output required )"),
