    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                0.1,
                104.0,
                "Test 8: None value for absolute difference threshold",
            ),
            (
                "A",
                "202312",
                ...
                None,
                106.0,
                "Test 9: None value for percentage difference threshold",
            ),
            (
                "A",
                "202312",
                ...
                None,
                99.0,
                "Test 10: None value for percentage difference threshold and absolute difference threshold",
            ),
        ],
    )
