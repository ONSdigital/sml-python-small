    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                0.1,
                True,
                "Test 3: Invalid predictive test",
            ),
            (
                "A",
                "202312",
            ...
            (
                ...
                0.1,
                True,
                "Test 5: Invalid absolute difference threshold",
            ),
            (
                "A",
                "202312",
                ...
                "0.1",
                True,
                "Test 6: Invalid percentage difference threshold",
            ),
            (
                "A",
                "202312",
                ...
                0.1,
                True,
                "Test 7: None value for absolute difference threshold",
            ),
            (
                "A",
                "202312",
                ...
                None,
                True,
                "Test 8: None value for percentage difference threshold",
            ),
        ],
    )
