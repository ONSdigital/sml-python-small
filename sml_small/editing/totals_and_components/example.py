    ...
    with open(
        ...
        for row in csv_reader:
            input_data = [
                ...
                (row["total"]),
                [
                    (None if not row["comp_1"]else row["comp_1"]),
                    (None if not row["comp_2"]else row["comp_2"]),
                    (None if not row["comp_3"]else row["comp_3"]),
                    (None if not row["comp_4"]else row["comp_4"]),
                ],
