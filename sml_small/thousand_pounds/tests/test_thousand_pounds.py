...
testdata = [
    ...
    pytest.param(
        ...
        id="Given config(missing predicted) - outputs adjusted for all target variables",
    ),
    pytest.param(
        "q400",
    ...
    pytest.param(
        ...
        Thousands_output("q500", None, [Target_variable("q501", 500), Target_variable("q502", 1000)], None, "E", "principal_variable is missing"),
    ...
    pytest.param(
        ...
        Thousands_output("q600", 0, [Target_variable("q601", 500, 500), Target_variable("q602", 1000, 1000)], 0, "N", ""),
    ...
    pytest.param(
        ...
        Thousands_output("q700", 3500, [Target_variable("q701", 500, 500)], 350, "N", ""),
    ...
    pytest.param(
        ...
        Thousands_output("q800", 13500, [Target_variable("q801", 500, 500)], 1350, "N", ""),
    ...
    pytest.param(
        ...
        1,  # lower limit
        [],
        Thousands_output("", 0, [], None, "E", "At least one of the lower or upper limits are 0 or missing"),
    ...
    pytest.param(
        ...
        "Custard",  # lower limit
        [],
        Thousands_output("Ham", "Cheese", [], None, "E", "unsupported operand type(s) for /: 'str' and 'str'"),
        id="Lower limit is 0 - default outputs and error indicated",
    ),
]


@pytest.mark.parametrize("principal_identifier, principal_variable, predicted, auxiliary, upper_limit, lower_limit, target_variables, expected", testdata)
def test__run__given_valid_config__returns_adjusted_figures(
    principal_identifier, principal_variable, predicted, auxiliary, upper_limit, lower_limit, target_variables, expected
):
    assert run(principal_identifier, principal_variable, predicted, auxiliary, upper_limit, lower_limit, target_variables) == expected
